package com.ljq.demo.springboot.swagger3.common.api;
...
public class ApiResult<T> implements Serializable {
     ...
     * 返回码，200 正常
     */
    @ApiModelProperty(value = "返回码，200 正常", name = "code", allowEmptyValue = true)
    private int code = 200;

    /**
     * 返回信息
     */
    @ApiModelProperty(value = "返回信息", name = "msg", allowEmptyValue = true)
    private String msg = "成功";

    /**
     * 返回数据
     */
    @ApiModelProperty(value = "返回数据对象", name = "data", allowEmptyValue = true)
    private T data;

    /**
     * 附加数据
     */
    @ApiModelProperty(value = "附加数据", name = "extraData", allowEmptyValue = true)
    private Map<String, Object> extraData;

    /**
     * 系统当前时间
     */
    @ApiModelProperty(value = "服务器系统时间，时间戳(精确到毫秒)", name = "timestamp", allowEmptyValue = true)
    ...
    public static ApiResult success() {
        return success(null, Collections.emptyMap());
    }
